...
public final class AuraEngine {
    ...
    private final DirectorStudioService directorStudioService;
    ...
    public AuraEngine(JavaPlugin plugin, ProtocolManager protocolManager) {
        ...
        this.directorController=new DirectorController(cameraManager,cameraController,actorPlaybackController);
        this.sceneCameraService=new SceneCameraService(cameraManager);
        this.sceneManager=new SceneManager(actorManager,actorPlaybackController,sceneCameraService,cameraController,directorController);
        this.sceneTimelineService=new SceneTimelineService();
        this.sceneStudioService=new SceneStudioService(sceneManager);
        this.directorStudioService=new DirectorStudioService(sceneManager,cameraManager,directorController);
